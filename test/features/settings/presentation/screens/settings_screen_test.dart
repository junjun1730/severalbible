...
void main() {
  Widget createSubject({
    ...
    final testRouter = router ?? GoRouter(
      ...
      routes: [
        ...
        GoRoute(
          ...
          builder: (context, state) => const Scaffold(body: Text('Premium Landing')),
        ),
        GoRoute(
          path: AppRoutes.manageSubscription,
          builder: (context, state) => const Scaffold(body: Text('Manage Subscription Page')),
        ),
        GoRoute(
    ...
    return ProviderScope(
      overrides: [
        ...
        hasPremiumProvider.overrideWith((ref) => Future.value(subscription != null)),
      ],
  ...
  group('SettingsScreen', () {
    ...
    testWidgets('tapping "Upgrade to Premium" navigates to premium landing', (tester) async {
      tester.view.physicalSize = const Size(1080, 2400);
      tester.view.devicePixelRatio = 3.0;
      addTearDown(tester.view.resetPhysicalSize);
    ...
    testWidgets('tapping "Manage Subscription" navigates to manage subscription screen', (tester) async {
      tester.view.physicalSize = const Size(1080, 2400);
      tester.view.devicePixelRatio = 3.0;
      addTearDown(tester.view.resetPhysicalSize);
