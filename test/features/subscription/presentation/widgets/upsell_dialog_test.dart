...
void main() {
  group('UpsellDialog', () {
    testWidgets('renders correct content for archive locked trigger', (
      tester,
    ) async {
      ...
      expect(
        find.textContaining('access your entire prayer note archive'),
        findsOneWidget,
      );
      expect(find.byIcon(Icons.history_edu), findsOneWidget);
    });

    testWidgets('renders correct content for content exhausted trigger', (
      tester,
    ) async {
      await tester.pumpWidget(
        const MaterialApp(
      ...
      expect(
        find.textContaining('unlimited access to daily scriptures'),
        findsOneWidget,
      );
      expect(find.byIcon(Icons.water_drop), findsOneWidget);
    });

    testWidgets('renders correct content for premium scripture trigger', (
      tester,
    ) async {
      await tester.pumpWidget(
        const MaterialApp(
    ...
    testWidgets('dismisses dialog when "Maybe Later" is tapped', (
      tester,
    ) async {
      await tester.pumpWidget(
        MaterialApp(
    ...
    testWidgets('displays different icons for each trigger type', (
      tester,
    ) async {
